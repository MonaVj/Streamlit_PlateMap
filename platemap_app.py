...
openai.api_key = "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"  # 🔴 Replace with your OpenAI API key

# Set Google Vision API credentials
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/content/platemap-450114-96d207fbbc28.json"  # 🔴 Replace with your Google Vision API key

# Add USDA API key
usda_api_key = "cHaFOwomrYzWix1VMyDcVgFULDhp7sueENA4STa1"  # 🔴 Replace with your USDA API key
...
def detect_food_from_image(image_path):
    ...
    for obj in response.localized_object_annotations:
        if obj.name.lower() in ["food", "dish", "plate"]:
            vertices = [(int(v.x * image_cv.shape[1]), int(v.y * image_cv.shape[0])) for v in obj.bounding_poly.normalized_vertices]
            ...
            cv2.putText(image_cv, obj.name, (vertices[0][0], vertices[0][1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
...
# Streamlit UI
st.title("🍽️ PlateMap: Taste Your Food, Learn Its Story!")
